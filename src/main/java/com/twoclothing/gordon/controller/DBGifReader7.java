...
@WebServlet("/DBGifReader7")
public class DBGifReader7 extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			ResultSet rs = stmt.executeQuery(
				"SELECT shopImg02 FROM twoclothing.members where mbrid="+mbrid);

			if (rs.next()) {
				BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream("shopImg02"));//�L����
