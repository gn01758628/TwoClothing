...
@WebServlet("/bidItemViewHistory.check")
public class BidItemViewHistoryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Integer> bitItemIdList = bidItemViewHistoryDAO.getAllBidItemIdByMbrId(mbrId);
