...
<title>競標商品檢舉資料新增 - addbidItRe.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>競標商品檢舉資料新增 - addbidItRe.jsp</h3></td><td>
...
<table>
	...
	<tr>
		<td>競標商品編號:</td>
		<td><input type="TEXT" name="biditemid" value="${param.bidItemId}" size="45"/></td> 
	</tr>
	<tr>
		<td>檢舉會員ID:</td>
		<td><input type="TEXT" name="mbrid"   value="${param.mbrId}"   size="45"/></td> 
	</tr>

	<tr>
		<td>檢舉內容:</td>
		<td><input type="TEXT" name="description"   value="${param.description}"   size="45"/></td> 
	</tr>
