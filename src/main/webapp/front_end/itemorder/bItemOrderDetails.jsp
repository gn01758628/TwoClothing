                ...
                <div class="form-container">
				    ...
				    <div class="row">
				        ...
				        <div class="form-group">
						    ...
						    <div class="rating">
						        <input value="5" name="buyStar" id="star5" type="radio" disabled ${itemOrder.buyStar eq 5 ? 'checked' : ''}>
						        <label title="text" for="star5"></label>
						        <input value="4" name="buyStar" id="star4" type="radio" disabled ${itemOrder.buyStar eq 4 ? 'checked' : ''}>
						        <label title="text" for="star4"></label>
						        <input value="3" name="buyStar" id="star3" type="radio" disabled ${itemOrder.buyStar eq 3 ? 'checked' : ''}>
						        <label title="text" for="star3"></label>
						        <input value="2" name="buyStar" id="star2" type="radio" disabled ${itemOrder.buyStar eq 2 ? 'checked' : ''}>
						        <label title="text" for="star2"></label>
						        <input value="1" name="buyStar" id="star1" type="radio" disabled ${itemOrder.buyStar eq 1 ? 'checked' : ''}>
				    ...
				    <div class="row">
				        ...
				        <div class="form-group">
						    ...
						    <div class="rating">
						        <input value="5" name="sellStar" id="star5" type="radio" disabled ${itemOrder.sellStar eq 5 ? 'checked' : ''}>
						        <label title="text" for="star5"></label>
						        <input value="4" name="sellStar" id="star4" type="radio" disabled ${itemOrder.sellStar eq 4 ? 'checked' : ''}>
						        <label title="text" for="star4"></label>
						        <input value="3" name="sellStar" id="star3" type="radio" disabled ${itemOrder.sellStar eq 3 ? 'checked' : ''}>
						        <label title="text" for="star3"></label>
						        <input value="2" name="sellStar" id="star2" type="radio" disabled ${itemOrder.sellStar eq 2 ? 'checked' : ''}>
						        <label title="text" for="star2"></label>
						        <input value="1" name="sellStar" id="star1" type="radio" disabled ${itemOrder.sellStar eq 1 ? 'checked' : ''}>
						        <label title="text" for="star1"></label>
						    </div>
						</div>
                    ...
                    <div class="form-group">
                        <button type="button" class="btn btn-primary" style="margin-top:20px" onclick="goBack()">返回</button>
                    </div>
                </div>
...
//選擇所有具有 texteditor class 的元素
var editorElements = document.querySelectorAll('.texteditor');
	let editor;
