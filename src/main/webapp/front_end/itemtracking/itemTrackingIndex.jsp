...
<body>
	...
	<form method="post" action="${pageContext.request.contextPath}/itemtracking">
		<h5>查詢單一會員所有商品追蹤</h5>
		<label>會員編號</label> <input type="text" name="mbrId">
		<br>
		<input type="hidden" name="action" value="getAllByMbrId">
