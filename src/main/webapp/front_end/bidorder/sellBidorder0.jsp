	...
	<c:forEach var="BidOrder" items="${BidOrder}" >
		...
		<td>
			<button type="button" onclick="confirmCancelOrder(${BidOrder.bidOrderId})">取消訂單</button>
		 	 <FORM id="${BidOrder.bidOrderId}" METHOD="post" ACTION="<%=request.getContextPath()%>/bidorder/BidOrder.do" style="margin-bottom: 0px;">
			     ...
			     <input type="hidden" name="action"	value="sell_Cancel_Order">
		     </FORM>
		</td>
		</tr>
