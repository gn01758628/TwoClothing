...
<!--           <button id="profile-edit"><a href="front_end/employee/select_page.jsp">上傳頭像</a></button> -->
    ...
    <nav class="sidebar-nav">
      <ul>
        ...
        <c:if test="${emp.empStatus eq 2 or emp.empMissions.charAt(0) eq 49}">
	        <li>
...
<!--         </li> -->
        ...
        <c:if test="${emp.empStatus eq 2 or emp.empMissions.charAt(1) eq 49}">
	        <li>
        ...
        <c:if test="${emp.empStatus eq 2 or emp.empMissions.charAt(2) eq 49}">
	        <li>
        ...
        <c:if test="${emp.empStatus eq 2 or emp.empMissions.charAt(3) eq 49}">
	        <li>
        ...
        <c:if test="${emp.empStatus eq 2 or emp.empMissions.charAt(6) eq 49}">
	        <li>
