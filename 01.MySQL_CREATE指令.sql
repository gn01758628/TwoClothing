...
VALUES
("競標商品01", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品01詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品02", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品02詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品03", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品03詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品04", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品04詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品05", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品05詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品06", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品06詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品07", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品07詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品08", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品08詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品09", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品09詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品10", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品10詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品11", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品11詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品12", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品12詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品13", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品13詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品14", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品14詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品15", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品15詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品16", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品16詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品17", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品17詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品18", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品18詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品19", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品19詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
...
IF(STARTTIME IS NOT NULL, 
    DATE_ADD(STARTTIME, INTERVAL 7 DAY) + INTERVAL 12 HOUR + INTERVAL 5 MINUTE + INTERVAL FLOOR(RAND() * 50) SECOND, NULL), 
IF(BIDSTATUS = 1, FLOOR(RAND() * 10) + 1, NULL)),
("競標商品20", FLOOR(RAND() * 5), FLOOR(RAND() * 8), "競標商品20詳細內容", FLOOR(3 + RAND() * 8), FLOOR(RAND() * 2) + 1, FLOOR(RAND() * 10 + 1) * 100,
IF(RAND() > 0.5, FLOOR(RAND() * 10 + 1) * 100 + 100, NULL), 
IF(RAND() > 0.5, 
    CASE WHEN RESERVEPRICE IS NOT NULL THEN FLOOR(RESERVEPRICE + 100) ELSE FLOOR(STARTPRICE + 100) END, 
    NULL), 
